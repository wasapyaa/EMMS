...
<head>
    <meta charset="utf-8">
    <title>Your Registration OTP Code</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                Thank you for signing up for the Event Merit Management System (EMMS). 
                Please use the One-Time Password (OTP) below to verify your email address and complete your registration:
            </div>
            ...
            <div class="message">
                If you did not request to register for this system, you can safely ignore this email.
            </div>
        </div>
        <div class="footer">
