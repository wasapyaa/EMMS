...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h5 class="fw-bold mb-0">
        <i class="bi bi-lightbulb text-primary me-2"></i> Event Ideas from Students
    </h5>
</div>
...
<div class="content-box p-0 overflow-hidden" style="border: 1px solid #eef2f6;">
    <div class="p-4 bg-white">
        <p class="text-muted mb-4" style="font-size: 0.92rem;">
            Below are the event ideas suggested by students. Ideas with higher net scores are more popular among students. Use these ideas as inspiration for your next event proposal!
        </p>
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f3f4f6;">
                    ...
                    <td class="text-secondary" style="font-size: 0.88rem; max-width: 250px;">
                ...
                <tr>
                    <td colspan="6" class="text-center py-5 text-muted">
                        ...
                        No event ideas have been suggested by students yet.
                    </td>
                </tr>
                @endforelse
            </tbody>
